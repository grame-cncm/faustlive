...
\subsubsection{MIDI Interface}
	You can control your application with a MIDI controler. To enable this feature, you have the following possibility :
	\begin{itemize}
	\item In "Parameters", in the tab "MIDI Interface", check "Enable"
	\end{itemize}
