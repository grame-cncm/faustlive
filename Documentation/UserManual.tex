...
The number of voices for the polyphonic instrument can be chosen in the Parameters", in the "Polyphony support". The polyphonic instrument can then be controlled with MIDI messages by checking the  "Enable Interface" in the "MIDI Interface" tab.
