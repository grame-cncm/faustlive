...
/* This way of encoding might seem random but it's the only one working !! */
...
//Receiving the sha key generated by the server, responding to the post request
