...
//
//  
//	This is an attempt to add remote server feature to FaustLive 
//	And make sure that the factories/instances created have the same behavior than 
//	the local ones created in FaustLive
//	
