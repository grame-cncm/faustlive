...
@.str1 = private unnamed_addr constant [24 x i8] c"physical cpu cores: %d\0A\00", align 1
@.str2 = private unnamed_addr constant [14 x i8] c"hw.logicalcpu\00", align 1
@.str3 = private unnamed_addr constant [23 x i8] c"logical cpu cores: %d\0A\00", align 1
...
@.str4 = private unnamed_addr constant [16 x i8] c"OMP_NUM_THREADS\00", align 1
@.str5 = private unnamed_addr constant [13 x i8] c"CLOCKSPERSEC\00", align 1
@.str6 = private unnamed_addr constant [17 x i8] c"OMP_STEALING_DUR\00", align 1
@.str7 = private unnamed_addr constant [15 x i8] c"OMP_DYN_THREAD\00", align 1
@.str8 = private unnamed_addr constant [13 x i8] c"OMP_REALTIME\00", align 1
@.str9 = private unnamed_addr constant [80 x i8] c"Cannot request joinable thread creation for real-time thread res = %d err = %s\0A\00", align 1
@.str10 = private unnamed_addr constant [68 x i8] c"Cannot set scheduling scope for real-time thread res = %d err = %s\0A\00", align 1
@.str11 = private unnamed_addr constant [68 x i8] c"Cannot request explicit scheduling for RT thread res = %d err = %s\0A\00", align 1
@.str12 = private unnamed_addr constant [64 x i8] c"Cannot set RR scheduling class for RT thread res = %d err = %s\0A\00", align 1
@.str13 = private unnamed_addr constant [64 x i8] c"Cannot set scheduling priority for RT thread res = %d err = %s\0A\00", align 1
@.str14 = private unnamed_addr constant [48 x i8] c"Cannot set thread stack size res = %d err = %s\0A\00", align 1
@.str15 = private unnamed_addr constant [40 x i8] c"Cannot create thread res = %d err = %s\0A\00", align 1
@.str16 = private unnamed_addr constant [19 x i8] c"set_affinity = %d\0A\00", align 1
@.str17 = private unnamed_addr constant [19 x i8] c"get_affinity = %d\0A\00", align 1
...
entry:
  ...
  store i32 0, i32* %physical_count, align 4, !tbaa !0
  store i64 4, i64* %size, align 8, !tbaa !3
  ...
  %1 = load i32* %physical_count, align 4, !tbaa !0
  %call1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([24 x i8]* @.str1, i64 0, i64 0), i32 %1)
  store i32 0, i32* %logical_count, align 4, !tbaa !0
  %2 = bitcast i32* %logical_count to i8*
  %call2 = call i32 @sysctlbyname(i8* getelementptr inbounds ([14 x i8]* @.str2, i64 0, i64 0), i8* %2, i64* %size, i8* null, i64 0)
  %3 = load i32* %logical_count, align 4, !tbaa !0
  %call3 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str3, i64 0, i64 0), i32 %3)
  %4 = load i32* %physical_count, align 4, !tbaa !0
  ret i32 %4
}
...
entry:
  ...
  %0 = load double* @_ZL10gTimeRatio, align 8, !tbaa !4
...
entry:
  ...
  %0 = load i64* @_ZL7gPeriod, align 8, !tbaa !5
  %cmp = icmp eq i64 %0, 0
...
if.then:                                          ; preds = %entry
  ...
  store i32 4, i32* %count.i, align 4, !tbaa !0
  store i32 0, i32* %get_default.i, align 4, !tbaa !0
...
_ZN13DSPThreadPoolC2Ei.exit:                      ; preds = %for.body.i.preheader, %for.body.for.body_crit_edge.i, %entry
  ...
  store i32 0, i32* %fThreadCount.i, align 4, !tbaa !0
  %fCurThreadCount.i = getelementptr inbounds %class.DSPThreadPool* %this, i64 0, i32 2
  store volatile i32 0, i32* %fCurThreadCount.i, align 4, !tbaa !0
  ret void
}
...
for.end:                                          ; preds = %for.body, %entry
  ...
  store i32 0, i32* %fThreadCount, align 4, !tbaa !0
  %fCurThreadCount = getelementptr inbounds %class.DSPThreadPool* %this, i64 0, i32 2
  store volatile i32 0, i32* %fCurThreadCount, align 4, !tbaa !0
  ret void
}
...
entry:
  %fThreadCount.i = getelementptr inbounds %class.DSPThreadPool* %this, i64 0, i32 1
  %0 = load i32* %fThreadCount.i, align 4, !tbaa !0
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  %4 = load i32* %fThreadCount.i, align 4, !tbaa !0
...
delete.notnull:                                   ; preds = %for.body
  ...
  %.pre = load %class.DSPThread*** %fThreadPool, align 8, !tbaa !6
  %.pre12 = load i32* %fThreadCount.i, align 4, !tbaa !0
  br label %delete.end
...
entry:
  %fThreadCount = getelementptr inbounds %class.DSPThreadPool* %this, i64 0, i32 1
  %0 = load i32* %fThreadCount, align 4, !tbaa !0
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %indvars.iv.next = add i64 %indvars.iv, 1
  %4 = load i32* %fThreadCount, align 4, !tbaa !0
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = load i32* @mach_task_self_, align 4, !tbaa !0
...
invoke.cont:                                      ; preds = %call.i.i.i.i.noexc
  ...
  %14 = load i32* %fThreadCount, align 4, !tbaa !0
  %inc = add nsw i32 %14, 1
  store i32 %inc, i32* %fThreadCount, align 4, !tbaa !0
  %indvars.iv.next = add i64 %indvars.iv, 1
  br label %for.cond
...
if.else:                                          ; preds = %entry
  %call2 = call i8* @getenv(i8* getelementptr inbounds ([13 x i8]* @.str8, i64 0, i64 0))
...
if.then11:                                        ; preds = %if.end
  ...
  %0 = load i32* %call12, align 4, !tbaa !0
  %call13 = call i8* @"\01_strerror"(i32 %0)
  %call14 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([80 x i8]* @.str9, i64 0, i64 0), i32 %call9, i8* %call13)
  br label %return
...
if.then18:                                        ; preds = %if.end15
  ...
  %1 = load i32* %call19, align 4, !tbaa !0
  %call20 = call i8* @"\01_strerror"(i32 %1)
  %call21 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([68 x i8]* @.str10, i64 0, i64 0), i32 %call16, i8* %call20)
  br label %return
...
if.then27:                                        ; preds = %if.then24
  ...
  %2 = load i32* %call28, align 4, !tbaa !0
  %call29 = call i8* @"\01_strerror"(i32 %2)
  %call30 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([68 x i8]* @.str11, i64 0, i64 0), i32 %call25, i8* %call29)
  br label %return
...
if.then34:                                        ; preds = %if.end31
  ...
  %3 = load i32* %call35, align 4, !tbaa !0
  %call36 = call i8* @"\01_strerror"(i32 %3)
  %call37 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([64 x i8]* @.str12, i64 0, i64 0), i32 %call32, i8* %call36)
  br label %return

if.end38:                                         ; preds = %if.end31
  store i64 0, i64* %rt_param, align 8
  %sched_priority = bitcast i64* %rt_param to i32*
  store i32 60, i32* %sched_priority, align 8, !tbaa !0
...
if.then41:                                        ; preds = %if.end38
  ...
  %4 = load i32* %call42, align 4, !tbaa !0
  %call43 = call i8* @"\01_strerror"(i32 %4)
  %call44 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([64 x i8]* @.str13, i64 0, i64 0), i32 %call39, i8* %call43)
  br label %return
...
if.then49:                                        ; preds = %if.else46
  ...
  %5 = load i32* %call50, align 4, !tbaa !0
  %call51 = call i8* @"\01_strerror"(i32 %5)
  %call52 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([68 x i8]* @.str11, i64 0, i64 0), i32 %call47, i8* %call51)
  br label %return
...
if.then57:                                        ; preds = %if.end54
  ...
  %6 = load i32* %call58, align 4, !tbaa !0
  %call59 = call i8* @"\01_strerror"(i32 %6)
  %call60 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([48 x i8]* @.str14, i64 0, i64 0), i32 %call55, i8* %call59)
  br label %return
...
if.then64:                                        ; preds = %if.end61
  ...
  %8 = load i32* %call65, align 4, !tbaa !0
  %call66 = call i8* @"\01_strerror"(i32 %8)
  %call67 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([40 x i8]* @.str15, i64 0, i64 0), i32 %call62, i8* %call66)
  br label %return
...
if.end68:                                         ; preds = %if.end61
  ...
  %10 = load i32* %fNumThread, align 4, !tbaa !0
  ...
  store i32 %add, i32* %affinity_tag.i, align 4, !tbaa !0
  ...
  %cmp.i = icmp eq i32 %call1.i, 0
  br i1 %cmp.i, label %if.then.i, label %_ZL12set_affinityP17_opaque_pthread_ti.exit

if.then.i:                                        ; preds = %if.end68
  %12 = load i32* %affinity_tag.i, align 4, !tbaa !0
  %call3.i = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([19 x i8]* @.str16, i64 0, i64 0), i32 %12)
  br label %_ZL12set_affinityP17_opaque_pthread_ti.exit

_ZL12set_affinityP17_opaque_pthread_ti.exit:      ; preds = %if.end68, %if.then.i
  call void @llvm.lifetime.end(i64 -1, i8* %11)
  %call70 = call i32 @pthread_attr_destroy(%struct._opaque_pthread_attr_t* %attributes)
  br label %return

return:                                           ; preds = %_ZL12set_affinityP17_opaque_pthread_ti.exit, %if.then64, %if.then57, %if.then49, %if.then41, %if.then34, %if.then27, %if.then18, %if.then11
  %retval.0 = phi i32 [ -1, %if.then11 ], [ -1, %if.then18 ], [ -1, %if.then27 ], [ -1, %if.then34 ], [ -1, %if.then41 ], [ -1, %if.then57 ], [ -1, %if.then64 ], [ 0, %_ZL12set_affinityP17_opaque_pthread_ti.exit ], [ -1, %if.then49 ]
  ret i32 %retval.0
}
...
entry:
  %fCurThreadCount = getelementptr inbounds %class.DSPThreadPool* %this, i64 0, i32 2
  store volatile i32 %num_thread, i32* %fCurThreadCount, align 4, !tbaa !0
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph
  ...
  %2 = load i32* %_sem.i.i, align 4, !tbaa !0
...
entry:
  ...
  %1 = load i32* %fThreadCount.i.i, align 4, !tbaa !0
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %5 = load i32* %fThreadCount.i.i, align 4, !tbaa !0
...
if.then.i.i:                                      ; preds = %entry
  ...
  %2 = load double* @_ZL10gTimeRatio, align 8, !tbaa !4
  ...
  store i64 %conv1.i.i.i, i64* %3, align 8, !tbaa !5
...
_ZN16DynThreadAdapter12StartMeasureEv.exit.i:     ; preds = %if.then.i.i, %entry
  ...
  store volatile i32 %sub.i, i32* %fCurThreadCount.i.i, align 4, !tbaa !0
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %9 = load i32* %_sem.i.i.i.i, align 4, !tbaa !0
...
entry:
  %fThreadPool.i = bitcast i8* %scheduler to %class.DSPThreadPool**
  %0 = load %class.DSPThreadPool** %fThreadPool.i, align 8, !tbaa !6
  %fCurThreadCount.i.i = getelementptr inbounds %class.DSPThreadPool* %0, i64 0, i32 2
  br label %while.cond.i

while.cond.i:                                     ; preds = %while.cond.i, %entry
  %1 = load volatile i32* %fCurThreadCount.i.i, align 4, !tbaa !0
  %cmp.i.i = icmp eq i32 %1, 0
  br i1 %cmp.i.i, label %_ZN21WorkStealingScheduler7SyncAllEv.exit, label %while.cond.i

_ZN21WorkStealingScheduler7SyncAllEv.exit:        ; preds = %while.cond.i
  %fDynThreadAdapter.i = getelementptr inbounds i8* %scheduler, i64 24
  %2 = bitcast i8* %fDynThreadAdapter.i to %class.DynThreadAdapter*
  %fStaticNumThreads.i = getelementptr inbounds i8* %scheduler, i64 460
  %3 = bitcast i8* %fStaticNumThreads.i to i32*
  %4 = load i32* %3, align 4, !tbaa !0
  %fDynamicNumThreads.i = getelementptr inbounds i8* %scheduler, i64 456
  %5 = bitcast i8* %fDynamicNumThreads.i to i32*
  tail call void @_ZN16DynThreadAdapter11StopMeasureEiRi(%class.DynThreadAdapter* %2, i32 %4, i32* %5)
  ret void
}
...
entry:
  ...
  store i32 %task_num, i32* %arrayidx.i.i, align 4, !tbaa !0
...
do.body.i.i.i:                                    ; preds = %if.else.i.i.i, %for.body.i.i
  %6 = load volatile i32* %fValue.i17.i.i.i, align 4, !tbaa !0
...
if.else.i.i.i:                                    ; preds = %do.body.i.i.i
  ...
  store volatile i32 %6, i32* %value.addr.i.i.i.i, align 4, !tbaa !0
  %12 = load volatile i32* %value.addr.i.i.i.i, align 4, !tbaa !0
...
_ZN9TaskQueue7PopTailEv.exit.i.i:                 ; preds = %if.else.i.i.i
  ...
  %16 = load i32* %arrayidx.i.i.i, align 4, !tbaa !0
...
entry:
  ...
  store volatile i32 %count, i32* %arrayidx.i.i, align 4, !tbaa !0
  ret void
}
...
if.else.i.i:                                      ; preds = %if.then.i.i
  ...
  store i32 %task, i32* %arrayidx.i.i.i, align 4, !tbaa !0
...
do.body.i.i.i:                                    ; preds = %if.else.i.i.i, %if.else.i.i
  %7 = load volatile i32* %fValue.i18.i.i.i, align 4, !tbaa !0
...
if.else.i.i.i:                                    ; preds = %do.body.i.i.i
  ...
  store volatile i32 %7, i32* %value.addr.i.i.i.i, align 4, !tbaa !0
  %12 = load volatile i32* %value.addr.i.i.i.i, align 4, !tbaa !0
...
entry:
  ...
  %0 = bitcast i8* %fTaskQueueList.i to %class.TaskQueue**
  %1 = load %class.TaskQueue** %0, align 8, !tbaa !6
  %2 = load i32* %task_num, align 4, !tbaa !0
...
do.body.i.i.i:                                    ; preds = %if.else.i.i.i, %if.then.i.i
  %4 = load volatile i32* %fValue.i18.i.i.i, align 4, !tbaa !0
...
if.else.i.i.i:                                    ; preds = %do.body.i.i.i
  ...
  store volatile i32 %4, i32* %value.addr.i.i.i.i, align 4, !tbaa !0
  %9 = load volatile i32* %value.addr.i.i.i.i, align 4, !tbaa !0
...
do.end.i.i.i:                                     ; preds = %if.else.i.i.i
  ...
  %13 = load i32* %arrayidx.i.i.i, align 4, !tbaa !0
...
_ZN9TaskQueue7PopHeadEv.exit.i.i:                 ; preds = %do.body.i.i.i, %do.end.i.i.i
  ...
  store i32 %retval.0.i.i.i, i32* %task_num, align 4, !tbaa !0
...
entry:
  ...
  %1 = load i32* %fDynamicNumThreads, align 4, !tbaa !0
...
for.body.i:                                       ; preds = %entry, %_ZN9TaskQueue7InitOneEv.exit.i
  ...
  %2 = load i32* %fTaskQueueSize.i.i, align 4, !tbaa !0
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %indvars.iv.next.i.i = add i64 %indvars.iv.i.i, 1
  %4 = load i32* %fTaskQueueSize.i.i, align 4, !tbaa !0
...
_ZN9TaskQueue7InitOneEv.exit.i:                   ; preds = %for.body.i.i, %for.body.i
  ...
  store volatile i32 0, i32* %fValue.i.i, align 4, !tbaa !0
  %fStealingStart.i.i = getelementptr inbounds %class.TaskQueue* %0, i64 %indvars.iv.i, i32 3
  store i64 0, i64* %fStealingStart.i.i, align 8, !tbaa !5
  %indvars.iv.next.i = add i64 %indvars.iv.i, 1
...
for.cond.preheader:                               ; preds = %_ZN9TaskQueue7InitAllEPS_i.exit
  %6 = load i32* %fDynamicNumThreads, align 4, !tbaa !0
...
for.cond7.preheader:                              ; preds = %_ZN9TaskQueue7InitAllEPS_i.exit
  ...
  %9 = load i32* %fReadyTaskListSize8, align 4, !tbaa !0
...
for.body:                                         ; preds = %_ZN9TaskQueue12InitTaskListEiPiii.exit, %for.body.lr.ph
  ...
  %14 = load i32* %fReadyTaskListSize, align 4, !tbaa !0
...
for.body.i23:                                     ; preds = %for.body.i23, %for.body.lr.ph.i
  ...
  %19 = load i32* %arrayidx.i21, align 4, !tbaa !0
  ...
  store i32 %19, i32* %arrayidx.i.i22, align 4, !tbaa !0
...
for.body6.i:                                      ; preds = %for.body6.i, %for.body6.lr.ph.i
  ...
  %25 = load i32* %arrayidx10.i, align 4, !tbaa !0
  ...
  store i32 %25, i32* %arrayidx.i18.i, align 4, !tbaa !0
...
_ZN9TaskQueue12InitTaskListEiPiii.exit:           ; preds = %for.body6.i, %for.end.i
  ...
  %28 = load i32* %fDynamicNumThreads, align 4, !tbaa !0
...
for.body10:                                       ; preds = %for.body10.lr.ph, %for.body10
  ...
  %30 = load i32* %arrayidx16, align 4, !tbaa !0
...
entry:
  ...
  store i32 %inc.i, i32* %0, align 4, !tbaa !0
  ...
  store i32 %task_num, i32* %arrayidx.i, align 4, !tbaa !0
  ret void
}
...
if.end:                                           ; preds = %entry
  ...
  %1 = load double* @_ZL10gTimeRatio, align 8, !tbaa !4
  ...
  store i64 %conv1.i, i64* %fStop, align 8, !tbaa !5
  %fCounter = getelementptr inbounds %class.DynThreadAdapter* %this, i64 0, i32 3
  %2 = load i32* %fCounter, align 4, !tbaa !0
  %add = add nsw i32 %2, 1
  %rem = srem i32 %add, 50
  store i32 %rem, i32* %fCounter, align 4, !tbaa !0
...
for.body.i:                                       ; preds = %if.end, %for.body.i
  ...
  %3 = load i64* %arrayidx.i, align 8, !tbaa !5
...
if.then10:                                        ; preds = %_ZN16DynThreadAdapter11ComputeMeanEv.exit
  ...
  %6 = load i32* %fOldfDynamicNumThreads, align 4, !tbaa !0
  %7 = load i32* %dynthreadnum, align 4, !tbaa !0
  %cmp14 = icmp sgt i32 %6, %7
  store i32 %7, i32* %fOldfDynamicNumThreads, align 4, !tbaa !0
  %8 = load i32* %dynthreadnum, align 4, !tbaa !0
...
if.then15:                                        ; preds = %if.then13
  ...
  store i32 %add17, i32* %dynthreadnum, align 4, !tbaa !0
  br label %if.end31

if.else:                                          ; preds = %if.then13
  %sub19 = add nsw i32 %8, -1
  store i32 %sub19, i32* %dynthreadnum, align 4, !tbaa !0
  br label %if.end31
...
if.then24:                                        ; preds = %if.else21
  ...
  store i32 %sub26, i32* %dynthreadnum, align 4, !tbaa !0
  br label %if.end31

if.else27:                                        ; preds = %if.else21
  %add29 = add nsw i32 %8, 1
  store i32 %add29, i32* %dynthreadnum, align 4, !tbaa !0
  br label %if.end31
...
entry:
  ...
  store i32 0, i32* %fCounter.i.i, align 4, !tbaa !0
  ...
  store i32 1, i32* %fOldfDynamicNumThreads.i.i, align 4, !tbaa !0
  ...
  %call.i.i = call i8* @getenv(i8* getelementptr inbounds ([15 x i8]* @.str7, i64 0, i64 0)) nounwind
...
_ZN16DynThreadAdapterC1Ev.exit:                   ; preds = %entry, %cond.true.i.i
  ...
  store i32 0, i32* %physical_count.i, align 4, !tbaa !0
  store i64 4, i64* %size.i, align 8, !tbaa !3
  %call.i = call i32 @sysctlbyname(i8* getelementptr inbounds ([15 x i8]* @.str, i64 0, i64 0), i8* %1, i64* %size.i, i8* null, i64 0)
  %4 = load i32* %physical_count.i, align 4, !tbaa !0
  %call1.i = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([24 x i8]* @.str1, i64 0, i64 0), i32 %4)
  store i32 0, i32* %logical_count.i, align 4, !tbaa !0
  %call2.i = call i32 @sysctlbyname(i8* getelementptr inbounds ([14 x i8]* @.str2, i64 0, i64 0), i8* %3, i64* %size.i, i8* null, i64 0)
  %5 = load i32* %logical_count.i, align 4, !tbaa !0
  %call3.i = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([23 x i8]* @.str3, i64 0, i64 0), i32 %5)
  %6 = load i32* %physical_count.i, align 4, !tbaa !0
  call void @llvm.lifetime.end(i64 -1, i8* %1)
  ...
  store i32 %6, i32* %fStaticNumThreads, align 4, !tbaa !0
  %call2 = call i8* @getenv(i8* getelementptr inbounds ([16 x i8]* @.str4, i64 0, i64 0))
...
cond.end:                                         ; preds = %_ZN16DynThreadAdapterC1Ev.exit, %cond.true
  %cond = phi i32 [ %call4, %cond.true ], [ %6, %_ZN16DynThreadAdapterC1Ev.exit ]
  %fDynamicNumThreads = getelementptr inbounds %class.WorkStealingScheduler* %this, i64 0, i32 4
  store i32 %cond, i32* %fDynamicNumThreads, align 4, !tbaa !0
  %call6 = call noalias i8* @_Znwm(i64 16)
  %7 = bitcast i8* %call6 to %class.DSPThreadPool*
  %8 = sext i32 %6 to i64
  %9 = call { i64, i1 } @llvm.umul.with.overflow.i64(i64 %8, i64 8)
  %10 = extractvalue { i64, i1 } %9, 1
  %11 = extractvalue { i64, i1 } %9, 0
  %12 = select i1 %10, i64 -1, i64 %11
  %call.i.i2223 = invoke noalias i8* @_Znam(i64 %12)
          to label %call.i.i22.noexc unwind label %lpad

call.i.i22.noexc:                                 ; preds = %cond.end
  %13 = bitcast i8* %call.i.i2223 to %class.DSPThread**
  %fThreadPool.i.i = bitcast i8* %call6 to %class.DSPThread***
  store %class.DSPThread** %13, %class.DSPThread*** %fThreadPool.i.i, align 8, !tbaa !6
...
for.body.i.preheader.i:                           ; preds = %call.i.i22.noexc
  store %class.DSPThread* null, %class.DSPThread** %13, align 8, !tbaa !6
  %exitcond.i2.i = icmp eq i32 %6, 1
...
for.body.for.body_crit_edge.i.i.preheader:        ; preds = %for.body.i.preheader.i
  ...
  %14 = bitcast i8* %arrayidx.i.i29 to %class.DSPThread**
  store %class.DSPThread* null, %class.DSPThread** %14, align 8, !tbaa !6
  %exitcond.i30 = icmp eq i32 %6, 2
...
for.body.for.body_crit_edge.i.for.body.for.body_crit_edge.i_crit_edge.i: ; preds = %for.body.for.body_crit_edge.i.i.preheader, %for.body.for.body_crit_edge.i.for.body.for.body_crit_edge.i_crit_edge.i.for.body.for.body_crit_edge.i.for.body.for.body_crit_edge.i_crit_edge.i_crit_edge
  %.pre.i.pre.i = phi %class.DSPThread** [ %.pre.i.pre.i.pre, %for.body.for.body_crit_edge.i.for.body.for.body_crit_edge.i_crit_edge.i.for.body.for.body_crit_edge.i.for.body.for.body_crit_edge.i_crit_edge.i_crit_edge ], [ %13, %for.body.for.body_crit_edge.i.i.preheader ]
...
invoke.cont:                                      ; preds = %for.body.for.body_crit_edge.i.i.preheader, %for.body.for.body_crit_edge.i.for.body.for.body_crit_edge.i_crit_edge.i, %for.body.i.preheader.i, %call.i.i22.noexc
  ...
  %15 = bitcast i8* %fThreadCount.i.i to i32*
  store i32 0, i32* %15, align 4, !tbaa !0
  %fCurThreadCount.i.i = getelementptr inbounds i8* %call6, i64 12
  %16 = bitcast i8* %fCurThreadCount.i.i to i32*
  store volatile i32 0, i32* %16, align 4, !tbaa !0
  %fThreadPool = getelementptr inbounds %class.WorkStealingScheduler* %this, i64 0, i32 0
  store %class.DSPThreadPool* %7, %class.DSPThreadPool** %fThreadPool, align 8, !tbaa !6
  %call8 = call noalias i8* @_Znwm(i64 16)
  %17 = bitcast i8* %call8 to %class.TaskGraph*
  %fTaskQueueSize.i.i = getelementptr inbounds i8* %call8, i64 8
  %18 = bitcast i8* %fTaskQueueSize.i.i to i32*
  store i32 %task_queue_size, i32* %18, align 4, !tbaa !0
  %19 = sext i32 %task_queue_size to i64
  %20 = call { i64, i1 } @llvm.umul.with.overflow.i64(i64 %19, i64 4)
  %21 = extractvalue { i64, i1 } %20, 1
  %22 = extractvalue { i64, i1 } %20, 0
  %23 = select i1 %21, i64 -1, i64 %22
  %call.i.i2427 = invoke noalias i8* @_Znam(i64 %23)
          to label %call.i.i24.noexc unwind label %lpad9

call.i.i24.noexc:                                 ; preds = %invoke.cont
  %24 = bitcast i8* %call.i.i2427 to i32*
  %fTaskList.i.i = bitcast i8* %call8 to i32**
  store i32* %24, i32** %fTaskList.i.i, align 8, !tbaa !6
...
for.body.i.i:                                     ; preds = %call.i.i24.noexc, %for.body.i.i
  ...
  %arrayidx.i.i25 = getelementptr inbounds i32* %24, i64 %indvars.iv.i.i
  store volatile i32 0, i32* %arrayidx.i.i25, align 4, !tbaa !0
...
invoke.cont10:                                    ; preds = %for.body.i.i, %call.i.i24.noexc
  %fTaskGraph = getelementptr inbounds %class.WorkStealingScheduler* %this, i64 0, i32 2
  store %class.TaskGraph* %17, %class.TaskGraph** %fTaskGraph, align 8, !tbaa !6
  %25 = load i32* %fStaticNumThreads, align 4, !tbaa !0
  ...
  %call12 = call noalias i8* @_Znam(i64 %34)
  %35 = bitcast i8* %call12 to i64*
  store i64 %26, i64* %35, align 8
  %36 = getelementptr inbounds i8* %call12, i64 8
  %37 = bitcast i8* %36 to %class.TaskQueue*
...
arrayctor.cont.thread:                            ; preds = %invoke.cont10
  ...
  store %class.TaskQueue* %37, %class.TaskQueue** %fTaskQueueList38, align 8, !tbaa !6
  br label %for.end

new.ctorloop:                                     ; preds = %invoke.cont10
  %arrayctor.end = getelementptr inbounds %class.TaskQueue* %37, i64 %26
  br label %invoke.cont14

invoke.cont14:                                    ; preds = %new.ctorloop, %invoke.cont14
  %arrayctor.cur = phi %class.TaskQueue* [ %37, %new.ctorloop ], [ %arrayctor.next, %invoke.cont14 ]
  %fValue.i.i.i.i = getelementptr inbounds %class.TaskQueue* %arrayctor.cur, i64 0, i32 2, i32 0, i32 0
  store i32 0, i32* %fValue.i.i.i.i, align 4, !tbaa !0
...
arrayctor.cont:                                   ; preds = %invoke.cont14
  %.pre = load i32* %fStaticNumThreads, align 4, !tbaa !0
  %fTaskQueueList = getelementptr inbounds %class.WorkStealingScheduler* %this, i64 0, i32 1
  store %class.TaskQueue* %37, %class.TaskQueue** %fTaskQueueList, align 8, !tbaa !6
  %cmp32 = icmp sgt i32 %.pre, 0
  br i1 %cmp32, label %for.body, label %for.end

for.body:                                         ; preds = %arrayctor.cont, %for.body.for.body_crit_edge
  %38 = phi %class.TaskQueue* [ %.pre37, %for.body.for.body_crit_edge ], [ %37, %arrayctor.cont ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body.for.body_crit_edge ], [ 0, %arrayctor.cont ]
  %arrayidx = getelementptr inbounds %class.TaskQueue* %38, i64 %indvars.iv
  call void @_ZN9TaskQueue4InitEi(%class.TaskQueue* %arrayidx, i32 %task_queue_size)
  %indvars.iv.next = add i64 %indvars.iv, 1
  %39 = load i32* %fStaticNumThreads, align 4, !tbaa !0
...
for.end:                                          ; preds = %for.body, %arrayctor.cont.thread, %arrayctor.cont
  %fReadyTaskListSize = getelementptr inbounds %class.WorkStealingScheduler* %this, i64 0, i32 7
  store i32 %init_task_list_size, i32* %fReadyTaskListSize, align 4, !tbaa !0
  %47 = sext i32 %init_task_list_size to i64
  %48 = call { i64, i1 } @llvm.umul.with.overflow.i64(i64 %47, i64 4)
  %49 = extractvalue { i64, i1 } %48, 1
  %50 = extractvalue { i64, i1 } %48, 0
  %51 = select i1 %49, i64 -1, i64 %50
  %call20 = call noalias i8* @_Znam(i64 %51)
  %52 = bitcast i8* %call20 to i32*
  %fReadyTaskList = getelementptr inbounds %class.WorkStealingScheduler* %this, i64 0, i32 6
  store i32* %52, i32** %fReadyTaskList, align 8, !tbaa !6
  %fReadyTaskListIndex = getelementptr inbounds %class.WorkStealingScheduler* %this, i64 0, i32 8
  store i32 0, i32* %fReadyTaskListIndex, align 4, !tbaa !0
  ret void

eh.resume:                                        ; preds = %lpad9, %lpad
  %exn.slot.0 = phi i8* [ %45, %lpad9 ], [ %42, %lpad ]
  %ehselector.slot.0 = phi i32 [ %46, %lpad9 ], [ %43, %lpad ]
...
entry:
  ...
  store i32 %task_queue_size, i32* %fTaskQueueSize, align 4, !tbaa !0
...
for.end:                                          ; preds = %for.body, %entry
  ...
  store i64 0, i64* %fStealingStart, align 8, !tbaa !5
  %call5 = tail call i8* @getenv(i8* getelementptr inbounds ([13 x i8]* @.str5, i64 0, i64 0))
...
cond.end:                                         ; preds = %for.end, %cond.true
  ...
  %call8 = tail call i8* @getenv(i8* getelementptr inbounds ([17 x i8]* @.str6, i64 0, i64 0))
...
cond.end17:                                       ; preds = %cond.false14, %cond.true10
  ...
  store i64 %cond18, i64* %fMaxStealing, align 8, !tbaa !5
  ret void
}
...
entry:
  ...
  %6 = bitcast %struct.thread_affinity_policy* %theTCPolicy.i to i8*
  call void @llvm.lifetime.start(i64 -1, i8* %6)
  ...
  store i32 1, i32* %count.i, align 4, !tbaa !0
  store i32 0, i32* %get_default.i, align 4, !tbaa !0
  %call.i = call i32 @pthread_mach_thread_np(%struct._opaque_pthread_t* %5)
  %9 = getelementptr inbounds %struct.thread_affinity_policy* %theTCPolicy.i, i64 0, i32 0
  %call1.i = call i32 @thread_policy_get(i32 %call.i, i32 4, i32* %9, i32* %count.i, i32* %get_default.i)
  %cmp.i = icmp eq i32 %call1.i, 0
  br i1 %cmp.i, label %if.then.i, label %_ZL12get_affinityP17_opaque_pthread_t.exit

if.then.i:                                        ; preds = %entry
  %10 = load i32* %9, align 4, !tbaa !0
  %call2.i = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([19 x i8]* @.str17, i64 0, i64 0), i32 %10)
  br label %_ZL12get_affinityP17_opaque_pthread_t.exit

_ZL12get_affinityP17_opaque_pthread_t.exit:       ; preds = %entry, %if.then.i
  call void @llvm.lifetime.end(i64 -1, i8* %6)
  call void @llvm.lifetime.end(i64 -1, i8* %7)
  call void @llvm.lifetime.end(i64 -1, i8* %8)
  %11 = getelementptr inbounds i8* %arg, i64 28
  %12 = load i8* %11, align 1, !tbaa !8, !range !9
  %tobool = icmp eq i8 %12, 0
  %_sem.i.i.pre = getelementptr inbounds i8* %arg, i64 24
  %.pre = bitcast i8* %_sem.i.i.pre to i32*
  br i1 %tobool, label %_ZL12get_affinityP17_opaque_pthread_t.exit.while.body.preheader_crit_edge, label %if.then

_ZL12get_affinityP17_opaque_pthread_t.exit.while.body.preheader_crit_edge: ; preds = %_ZL12get_affinityP17_opaque_pthread_t.exit
  %fDSP.i.pre = getelementptr inbounds i8* %arg, i64 40
  %.pre10 = bitcast i8* %fDSP.i.pre to i8**
  %fNumThread.i.pre = getelementptr inbounds i8* %arg, i64 32
  %.pre12 = bitcast i8* %fNumThread.i.pre to i32*
  %fThreadPool.i.pre = getelementptr inbounds i8* %arg, i64 16
  %.pre14 = bitcast i8* %fThreadPool.i.pre to %class.DSPThreadPool**
  br label %while.body.preheader

if.then:                                          ; preds = %_ZL12get_affinityP17_opaque_pthread_t.exit
  %13 = load i32* %.pre, align 4, !tbaa !0
  %call.i.i2 = call i32 @semaphore_wait(i32 %13)
  %fDSP.i3 = getelementptr inbounds i8* %arg, i64 40
  %14 = bitcast i8* %fDSP.i3 to i8**
  %15 = load i8** %14, align 8, !tbaa !6
  %fNumThread.i4 = getelementptr inbounds i8* %arg, i64 32
  %16 = bitcast i8* %fNumThread.i4 to i32*
  %17 = load i32* %16, align 4, !tbaa !0
  %add.i5 = add nsw i32 %17, 1
  call void @computeThreadExternal(i8* %15, i32 %add.i5)
  %fThreadPool.i6 = getelementptr inbounds i8* %arg, i64 16
  %18 = bitcast i8* %fThreadPool.i6 to %class.DSPThreadPool**
  %19 = load %class.DSPThreadPool** %18, align 8, !tbaa !6
  %fCurThreadCount.i.i7 = getelementptr inbounds %class.DSPThreadPool* %19, i64 0, i32 2
  %20 = atomicrmw add i32* %fCurThreadCount.i.i7, i32 -1 seq_cst
  %call.i8 = call %struct._opaque_pthread_t* @pthread_self()
  %21 = load i64* @_ZL7gPeriod, align 8, !tbaa !5
  %22 = load i64* @_ZL12gComputation, align 8, !tbaa !5
  %23 = load i64* @_ZL11gConstraint, align 8, !tbaa !5
  %24 = bitcast %struct.thread_time_constraint_policy* %theTCPolicy.i.i to i8*
  ...
  store i32 %conv.i.i, i32* %period1.i.i, align 4, !tbaa !0
  %conv2.i.i = trunc i64 %22 to i32
  %computation3.i.i = getelementptr inbounds %struct.thread_time_constraint_policy* %theTCPolicy.i.i, i64 0, i32 1
  store i32 %conv2.i.i, i32* %computation3.i.i, align 4, !tbaa !0
  %conv4.i.i = trunc i64 %23 to i32
  %constraint5.i.i = getelementptr inbounds %struct.thread_time_constraint_policy* %theTCPolicy.i.i, i64 0, i32 2
  store i32 %conv4.i.i, i32* %constraint5.i.i, align 4, !tbaa !0
  %preemptible.i.i = getelementptr inbounds %struct.thread_time_constraint_policy* %theTCPolicy.i.i, i64 0, i32 3
  store i32 1, i32* %preemptible.i.i, align 4, !tbaa !0
  %call.i.i9 = call i32 @pthread_mach_thread_np(%struct._opaque_pthread_t* %call.i8)
  %call6.i.i = call i32 @thread_policy_set(i32 %call.i.i9, i32 2, i32* %period1.i.i, i32 4)
  call void @llvm.lifetime.end(i64 -1, i8* %24)
  br label %while.body.preheader

while.body.preheader:                             ; preds = %_ZL12get_affinityP17_opaque_pthread_t.exit.while.body.preheader_crit_edge, %if.then
  %.pre-phi15 = phi %class.DSPThreadPool** [ %.pre14, %_ZL12get_affinityP17_opaque_pthread_t.exit.while.body.preheader_crit_edge ], [ %18, %if.then ]
  %.pre-phi13 = phi i32* [ %.pre12, %_ZL12get_affinityP17_opaque_pthread_t.exit.while.body.preheader_crit_edge ], [ %16, %if.then ]
  %.pre-phi11 = phi i8** [ %.pre10, %_ZL12get_affinityP17_opaque_pthread_t.exit.while.body.preheader_crit_edge ], [ %14, %if.then ]
  br label %while.body

while.body:                                       ; preds = %while.body.preheader, %while.body
  %25 = load i32* %.pre, align 4, !tbaa !0
  %call.i.i = call i32 @semaphore_wait(i32 %25)
  %26 = load i8** %.pre-phi11, align 8, !tbaa !6
  %27 = load i32* %.pre-phi13, align 4, !tbaa !0
  %add.i = add nsw i32 %27, 1
  call void @computeThreadExternal(i8* %26, i32 %add.i)
  %28 = load %class.DSPThreadPool** %.pre-phi15, align 8, !tbaa !6
  %fCurThreadCount.i.i = getelementptr inbounds %class.DSPThreadPool* %28, i64 0, i32 2
  %29 = atomicrmw add i32* %fCurThreadCount.i.i, i32 -1 seq_cst
  br label %while.body
}
...
entry:
  ...
  %1 = load i32* @mach_task_self_, align 4, !tbaa !0
  %_sem.i.i.i = getelementptr inbounds %class.DSPThread* %this, i64 0, i32 3, i32 0
  %2 = load i32* %_sem.i.i.i, align 4, !tbaa !0
...
entry:
  ...
  %2 = load i32* %_sem.i.i.i.i, align 4, !tbaa !0
