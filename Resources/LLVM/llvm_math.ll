...
@.str = private unnamed_addr constant [22 x i8] c"SIZE OF MALLOC = %zi\0A\00", align 1
...
entry:
  ...
  %call = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([22 x i8]* @.str, i32 0, i32 0), i64 %0)
  %1 = load i64* %size.addr, align 8
  %call1 = call i8* @malloc(i64 %1)
  ret i8* %call1
}
